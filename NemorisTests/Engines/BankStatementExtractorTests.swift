...
/// Extraction déterministe des opérations d'un relevé bancaire.
///
/// L'ancrage se fait sur la DATE, un relevé n'ayant pas d'équivalent de
/// l'ISIN. Les pièges verrouillés ici viennent tous de textes réels : une
/// date à points lue comme un montant, un séparateur de milliers qui ampute
/// silencieusement un millier, et « TOTAL » qui ne peut pas être un marqueur
/// de ligne de synthèse — TOTALENERGIES est un marchand courant.
