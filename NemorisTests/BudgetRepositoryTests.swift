...
/// The budget rests on three linked tables: recurring patterns, envelopes, and
/// the forecasts generated by the recurring patterns.
...
struct BudgetRepositoryTests {
    ...
    func enveloppeAnnuelle() throws {
        ...
        // Monthly conversion is the calculator's job, not the database's:
        // storing 100 instead of 1200 would make the entered amount unrecoverable.
        let e = repo.fetchEnvelopes()[0]
    ...
    func statutDePrevision() throws {
        ...
        // Switching to dismissed must release the match.
